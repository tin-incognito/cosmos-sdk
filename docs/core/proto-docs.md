...
- [cosmos/privacy/query.proto](#cosmos/privacy/query.proto)
    ...
    - [QueryEstimateFeeRequest](#cosmos.privacy.privacy.QueryEstimateFeeRequest)
    - [QueryEstimateFeeResponse](#cosmos.privacy.privacy.QueryEstimateFeeResponse)
...
<a name="cosmos.privacy.privacy.QueryEstimateFeeRequest"></a>

### QueryEstimateFeeRequest



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `privacyData` | [string](#string) |  |  |
...
<a name="cosmos.privacy.privacy.QueryEstimateFeeResponse"></a>

### QueryEstimateFeeResponse
...
| `EstimateFee` | [QueryEstimateFeeRequest](#cosmos.privacy.privacy.QueryEstimateFeeRequest) | [QueryEstimateFeeResponse](#cosmos.privacy.privacy.QueryEstimateFeeResponse) | Queries estimateFee | GET|/cosmos/privacy/estimate_fee|
