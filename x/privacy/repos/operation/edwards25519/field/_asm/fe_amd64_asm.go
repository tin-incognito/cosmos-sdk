...
func feSquare() {
	...
	// r0 = l0√ól0 + 19√ó2√ó(l1√ól4 + l2√ól3)
	r0 := uint128{"r0", GP64(), GP64()}
	mul64(r0, 1, l0, l0)
	addMul64(r0, 38, l1, l4)
	addMul64(r0, 38, l2, l3)

	// r1 = 2√ól0√ól1 + 19√ó2√ól2√ól4 + 19√ól3√ól3
	r1 := uint128{"r1", GP64(), GP64()}
	mul64(r1, 2, l0, l1)
	addMul64(r1, 38, l2, l4)
	addMul64(r1, 19, l3, l3)

	// r2 = = 2√ól0√ól2 + l1√ól1 + 19√ó2√ól3√ól4
	r2 := uint128{"r2", GP64(), GP64()}
	mul64(r2, 2, l0, l2)
	addMul64(r2, 1, l1, l1)
	addMul64(r2, 38, l3, l4)

	// r3 = = 2√ól0√ól3 + 2√ól1√ól2 + 19√ól4√ól4
	r3 := uint128{"r3", GP64(), GP64()}
	mul64(r3, 2, l0, l3)
	addMul64(r3, 2, l1, l2)
	addMul64(r3, 19, l4, l4)

	// r4 = = 2√ól0√ól4 + 2√ól1√ól3 + l2√ól2
...
func mul64(r uint128, i int, aX, bX namedComponent) {
	switch i {
	case 1:
		Comment(fmt.Sprintf("%s = %s√ó%s", r, aX, bX))
		Load(aX, RAX)
	case 2:
		Comment(fmt.Sprintf("%s = 2√ó%s√ó%s", r, aX, bX))
		Load(aX, RAX)
		SHLQ(Imm(1), RAX)
	default:
...
func addMul64(r uint128, i uint64, aX, bX namedComponent) {
	...
	case 1:
		...
		Load(aX, RAX)
	default:
		Comment(fmt.Sprintf("%s += %d√ó%s√ó%s", r, i, aX, bX))
